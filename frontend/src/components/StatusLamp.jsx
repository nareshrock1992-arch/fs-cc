const LAMP_MAP = {
  Available:        { color: 'bg-lamp-available', glow: '', pulse: false,
                      ...
                      label: 'Available' },
  'On Break':       { color: 'bg-lamp-break', glow: '', pulse: false,
  ...
  'Logged Out':     { color: 'bg-lamp-loggedout', glow: '', pulse: false,
                      ...
                      label: 'Logged Out' },
  Receiving:        { color: 'bg-lamp-live', glow: '', pulse: true,
                      text: 'text-amber-600 dark:text-lamp-live',
                      badge: 'bg-amber-50 dark:bg-amber-500/10 border-amber-200 dark:border-amber-500/20',
                      label: 'Ringing' },
  'In a queue call':{ color: 'bg-lamp-live', glow: '', pulse: true,
                      text: 'text-amber-600 dark:text-lamp-live',
                      badge: 'bg-amber-50 dark:bg-amber-500/10 border-amber-200 dark:border-amber-500/20',
                      label: 'In Call' },
  InQueue:          { color: 'bg-lamp-live', glow: '', pulse: true,
                      text: 'text-amber-600 dark:text-lamp-live',
                      badge: 'bg-amber-50 dark:bg-amber-500/10 border-amber-200 dark:border-amber-500/20',
                      label: 'In Queue' },
  Waiting:          { color: 'bg-lamp-available', glow: '', pulse: false,
                      text: 'text-emerald-600 dark:text-lamp-available',
                      badge: 'bg-emerald-50 dark:bg-emerald-500/10 border-emerald-200 dark:border-emerald-500/20',
                      label: 'Waiting' },
  Abandoned:        { color: 'bg-lamp-alert', glow: '', pulse: false,
